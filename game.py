...
def run():
    ...
    pl_rb = rigid_body(settings.sh_image.get_rect(center=(settings.sh_init_posx, settings.sh_init_posy)).copy())
    world.add_component(player, pl_rb)
    ...
    world.add_component(player, health_bar(settings.sh_health_bar_shifty, settings.sh_health_bar_height, pl_rb.collide_rect.top, pl_rb.collide_rect.left, pl_rb.collide_rect.width))
